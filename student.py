import os
from form import AddForm, DelForm, AddFatherForm
...
app.config['SECRET_KEY'] = 'kwonlegeshelf'
...
class Student(db.Model):
    ...
    def __repr__(self):
        if self.father:
            return f"Student name is {self.name}, id is {self.id} and father name {self.father.name}."
        else:
